...
Install-ChocolateyPackage `
    ...
    -FileType 'EXE' `
    -Url64bit 'https://repo.jellyfin.org/releases/server/windows/stable/installer/jellyfin_10.8.12_windows-x64.exe' `
    -Checksum64 'e892895b5a0e866f86a5efc4ba1ff1a490db8242ab550abbb3e970414e354598' `
